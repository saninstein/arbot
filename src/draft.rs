...
mod tests {
    ...
    use crate::core::dto::{Exchange, Instrument, Order, OrderSide, DTO, TICKER_PRICE_NOT_CHANGED};
    ...
    // #[test]
    // fn parse_mexc() {
    //     let raw: &str = r#"{"c":"spot@public.bookTicker.v3.api@VTHOUSDT","d":{"A":"159036.8","B":"4073815.39","a":"0.001564","b":"0.001548"},"s":"VTHOUSDT","t":1730981910190}"#;
    ...
    //
    //     let bid = &ticker_data["b"].as_str().unwrap();
    //     let ask = &ticker_data["a"].as_str().unwrap();
    //
    //
    //     let bid_price;
    //     let bid_amount;
    ...
    //         bid_amount = ticker_data["B"].as_str().unwrap().parse().unwrap();
    //     }
    //     if ask.is_empty() {
    ...
    //         ask_amount = ticker_data["A"].as_str().unwrap().parse().unwrap();
    //     }
    // }
